...
//   /**
//    * Prompts user to choose an option manually (only if no env variable is given)
//    */
...
// async placeBuyOrder(client, security, quantity, price, tif = 'DAY') {
//   // Select client UCC
...
//   await this.page.locator('#debtorder_0_spnPrice').fill(price.toString());
...
//   /**
//    * Places a Sell order dynamically
//    */
//   async placeSellOrder(client, security, quantity, price, tif = 'DAY') {
//     await this.page.getByRole('cell', { name: 'Sell' }).click();

//     await this.page.locator('#debtorder_0_cmbClientAcc').fill(client);
//     await this.page.getByRole('option', { name: new RegExp(client, 'i') }).click({ timeout: 5000 });

//     await this.page.locator('#debtorder_0_txtSecurity').fill(security);
//     await this.page.getByRole('option', { name: new RegExp(security, 'i') }).click({ timeout: 5000 });
